...
export default function Home() {
  ...
  return (
   <main>
      <section class="text-gray-600 body-font bg-[url('/images/bg.jpg')] bg-cover bg-center">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <img class="object-cover object-center rounded-full" alt="hero" src="/images/Doctor.gif"/>
          </div>
        </div>
